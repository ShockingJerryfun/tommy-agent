...
from .versions.v0006_production_multi_agent import PRODUCTION_MULTI_AGENT_DDL
...
_SCHEMA_VERSIONS = (
    ...
    SchemaVersion(6, "production multi-agent runtime tables", PRODUCTION_MULTI_AGENT_DDL),
)
